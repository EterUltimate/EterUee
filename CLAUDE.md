...
EterUee is a native Android LLM chat client with cyberpunk aesthetics — pure black background, RGB pure colors, zero-radius corners.
Built with Jetpack Compose, Kotlin, and a forced cyberpunk theme.
...
- Follow cyberpunk design: pure black `#000000` background, white `#FFFFFF` text/borders, RGB pure colors, all corners 0.dp
...
- New providers go in `ai/src/main/java/com/eterultimate/eteruee/ai/provider/providers/`
