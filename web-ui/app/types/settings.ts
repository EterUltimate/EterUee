/**
 * Display settings
 * @see app/src/main/java/com/eterultimate/eteruee/data/datastore/PreferencesStore.kt - DisplaySetting
 */
 ...
 * @see app/src/main/java/com/eterultimate/eteruee/data/datastore/PreferencesStore.kt - Settings
 */
