...
class TemplateTransformer(
    ...
    override suspend fun transform(
        ...
        return messages.map { message ->
            // System placeholders are handled by PlaceholderTransformer. Tool
            // and other non-chat roles are generated by the app/provider path,
            // so templating them can mutate stable prompt-cache prefixes.
            if (message.role != MessageRole.USER && message.role != MessageRole.ASSISTANT) return@map message
