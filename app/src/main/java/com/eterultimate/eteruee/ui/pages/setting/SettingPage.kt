...
import com.eterultimate.eteruee.data.datastore.isNotConfigured
...
import com.eterultimate.eteruee.ui.components.ui.Select
import com.eterultimate.eteruee.ui.components.ui.icons.DiscordIcon
        ...
        LazyColumn(
            ...
            item("generalSettings") {
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.SettingTrafficControl) },
                        leadingContent = { Icon(HugeIcons.ServerStack01, null) },
                        supportingContent = { Text(stringResource(R.string.setting_page_traffic_control_desc)) },
                        headlineContent = { Text(stringResource(R.string.setting_page_traffic_control)) },
                    )
                }
            }
            ...
            item("aboutSettings") {
                ...
                CardGroup(
                    ...
                    item(
                        onClick = { context.openUrl("https://github.com/EterUltimate/EterUee/wiki") },
