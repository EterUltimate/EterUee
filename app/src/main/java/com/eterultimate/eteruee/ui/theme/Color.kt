...
fun lightExtendColors(): ExtendColors = ExtendColors(
    ...
    green1 = Color(232, 232, 255),
    green2 = Color(195, 195, 254),
    green3 = Color(159, 159, 253),
    green4 = Color(123, 123, 252),
    green5 = Color(87, 87, 251),
    green6 = Color(52, 52, 250),
    green7 = Color(32, 32, 207),
    green8 = Color(17, 17, 163),
    green9 = Color(6, 6, 120),
    green10 = Color(0, 0, 77),
...
fun darkExtendColors(): ExtendColors = ExtendColors(
    ...
    green1 = Color(0xFF000033),
    green2 = Color(0xFF000055),
    green3 = Color(0xFF000077),
    green4 = Color(0xFF000099),
    green5 = Color(0xFF0000BB),
    green6 = Color(0xFF0000FF),
    green7 = Color(0xFF3333FF),
    green8 = Color(0xFF6666FF),
    green9 = Color(0xFF9999FF),
    green10 = Color(0xFFCCCCFF),
